...
test('model inversion routing: routes each known executor family to a different-family reflector', () => {
...
test('model inversion routing: never routes to the same family it detected', () => {
...
test('model inversion routing: returns null for unknown families so callers fall through to env/default', () => {
