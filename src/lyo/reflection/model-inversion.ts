...
export const INVERSION_MAP = new Map<string, string>([
...
export function executorFamily(executorModel: unknown): string | null {
...
export function invertedReflectorModel(executorModel: unknown): string | null {
