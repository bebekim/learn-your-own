...
test('fields are split on commas not enclosed in double quotes', () => {
...
test('two double quotes inside a quoted field decode to one literal double quote', () => {
...
test('empty field between consecutive commas', () => {
