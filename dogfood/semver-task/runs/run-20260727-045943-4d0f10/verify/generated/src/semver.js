const compareSemver = (a, b) => {
  ...
  // Per SemVer spec: when comparing prereleases, a shorter prerelease is lower precedence
  // ONLY when all preceding identifiers are equal
  ...
  // The one with fewer identifiers has lower precedence
